...
const ModalPegawai: React.FC<ModalPegawaiProps> = ({ pegawai }) => {
  ...
  return (
    <section className="flex flex-col gap-y-2 p-2 md:w-[30%] w-full shadow-md bg-[#F5F6F7] border rounded-md">
      <div className="w-[30%] items-center grid grid-cols-2">
      ...
      {showProvinsi && (
        <div className="w-[100%] items-center grid grid-cols-3">
          ...
          <p className="font-normal text-[0.8rem] col-span-2 md:-ml-14 ml-[-4.5rem]">
